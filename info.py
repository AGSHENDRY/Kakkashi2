...
BOT_TOKEN = environ.get('BOT_TOKEN', "8348783837:AAGWc8dKxueF4DRm1mVuVn1Lm5YQX5MByCU")

CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://files.catbox.moe/qnnmpa.jpg https://files.catbox.moe/2ab4tp.jpg')).split() 
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003454929996'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003211195934'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003454929996')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001614481524') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002109756713') 
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AgsModsOG')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AgsModsOG')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AgsModsOG')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/Ags_Updates')
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003454929996'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003454929996'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/AgsModsOG")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/AgsModsOG")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/AgsModsOG")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/AgsModsOG') 
